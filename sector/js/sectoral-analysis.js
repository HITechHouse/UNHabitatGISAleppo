            ...
            <div style="background: #f8f9fa; padding: 20px; border-radius: 12px; border: 1px solid #e9ecef;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px;">
                <label style="display: flex; align-items: center; gap: 8px;">
                  <input type="checkbox" checked> مرافق البنية التحتية
                </label>
                <label style="display: flex; align-items: center; gap: 8px;">
                  <input type="checkbox" checked> الخدمات العامة
                </label>
                <label style="display: flex; align-items: center; gap: 8px;">
                  <input type="checkbox" checked> الخدمات الأخرى
                </label>
                <label style="display: flex; align-items: center; gap: 8px;">
        ...
        <div style="height: 100%; overflow-y: auto;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #28a745, #1e7e34); color: white; padding: 15px; border-radius: 8px; text-align: center;">
              ...
              <div style="font-size: 12px; opacity: 0.9;">مرافق البنية التحتية</div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #17a2b8, #138496); color: white; padding: 15px; border-radius: 8px; text-align: center;">
              ...
              <div style="font-size: 12px; opacity: 0.9;">الخدمات الأخرى</div>
            </div>
...
window.showCompositeColoringWithSectoralGrid =
  showCompositeColoringWithSectoralGrid;
...
window.generateRandomSectoralFunctionality =
  generateRandomSectoralFunctionality;
