...
const tablesData = {
  ...
  "الخدمات الاجتماعية والتجارية": {
    fields: [
      { name: "معرف السجل", key: "id", editable: false },
      { name: "اسم المدينة", key: "city", editable: false },
      {
        name: "الخدمات الاجتماعية والتجارية",
        key: "other_service",
        editable: true,
        type: "select",
        options: [
  ...
  "تحليل علاقة الشركاء الفاعلين": {
    fields: [
      ...
      },
      {
        ...
        editable: true,
        type: "multiselect",
        options: ["شراكة", "تشاور", "إعلام", "مراقبة"],
      },
    ],
    sampleData: {
      id: "1",
  ...
  "الوحدات الإدارية": {
    fields: [
      ...
      },
      {
        ...
        editable: true,
        type: "text",
        placeholder: "ادخل نوع البيانات",
      },
      {
        name: "وقت جمع البيانات",
        key: "collection_time",
        editable: true,
        type: "text",
      ...
      },
      {
        ...
        editable: true,
        type: "textarea",
        placeholder: "ادخل المهام الإضافية",
      },
      {
        name: "الاحتياجات العامة",
        key: "general_needs",
        editable: true,
        type: "textarea",
        placeholder: "ادخل الاحتياجات",
      },
      {
        name: "عدد الحواسيب",
        key: "computer_count",
  ...
  table.fields.forEach((field, index) => {
    ...
    if (field.editable) {
      if (field.type === "select" && Array.isArray(field.options)) {
        ...
        // Create a custom multiselect container
        const multiselectContainer = document.createElement("div");
        multiselectContainer.className = "multiselect-container";
        multiselectContainer.style.border = "2px solid #ddd";
        multiselectContainer.style.borderRadius = "4px";
        multiselectContainer.style.backgroundColor = "#fff";
        multiselectContainer.style.minHeight = "120px";
        multiselectContainer.style.maxHeight = "200px";
        multiselectContainer.style.overflowY = "auto";
        multiselectContainer.style.padding = "8px";
        ...
        headerDiv.textContent = "اختر واحد أو أكثر من الخيارات:";
        multiselectContainer.appendChild(headerDiv);
        ...
        field.options.forEach((option, index) => {
          ...
          checkboxDiv.style.padding = "4px 6px";
          ...
          checkbox.addEventListener("change", function () {
            ...
            multiselectContainer.dataset.changed = "true";

            // Update the hidden input value
            const allCheckboxes = multiselectContainer.querySelectorAll(
              'input[type="checkbox"]'
            );
            ...
            // Store the selected values in a data attribute
            multiselectContainer.dataset.value =
              JSON.stringify(selectedOptions);

            // Trigger change event for composite update
            const changeEvent = new Event("change", { bubbles: true });
            multiselectContainer.dispatchEvent(changeEvent);
          });

          checkboxDiv.appendChild(checkbox);
          checkboxDiv.appendChild(label);
          multiselectContainer.appendChild(checkboxDiv);
        });

        // Create action buttons
        const buttonsDiv = document.createElement("div");
        buttonsDiv.style.marginTop = "8px";
        buttonsDiv.style.paddingTop = "8px";
        ...
        selectAllBtn.style.backgroundColor = "#f8f9fa";
        ...
        clearAllBtn.style.border = "1px solid #ddd";
        clearAllBtn.style.borderRadius = "3px";
        clearAllBtn.style.backgroundColor = "#f8f9fa";
        ...
        selectAllBtn.addEventListener("click", function (e) {
          ...
          multiselectContainer.dataset.value = JSON.stringify(selectedOptions);
          multiselectContainer.dataset.changed = "true";
        ...
        clearAllBtn.addEventListener("click", function (e) {
          ...
          // Trigger change event
          multiselectContainer.dataset.value = JSON.stringify([]);
          multiselectContainer.dataset.changed = "true";
        ...
        multiselectContainer.appendChild(buttonsDiv);

        // Set initial data attributes
        multiselectContainer.dataset.table = tabId;
        multiselectContainer.dataset.field = field.key;
        multiselectContainer.dataset.changed = "false";
        multiselectContainer.dataset.value = JSON.stringify(selectedValues);

        // Set inputElement to the container for consistent handling
        inputElement = multiselectContainer;
        ...
        switch (field.type) {
          case "number":
            ...
            // إضافة placeholder للحقول الرقمية
            if (field.placeholder) {
              inputElement.placeholder = field.placeholder;
            } else {
              inputElement.placeholder = "أدخل قيمة رقمية";
            }
    ...
    function updateCompositeFromInfoPanel(inputElement) {
      if (typeof window.updateCompositeValuesFromInfoPanel === "function") {
        ...
        if (
          ...
          // Handle multiselect fields (custom container)
          if (inputElement.classList.contains("multiselect-container")) {
            try {
...
function showFullscreenPopup() {
  ...
  if (popup) {
    ...
    const sectoralContainer = document.getElementById(
...
function showNumberRangeWarning() {
  ...
  warn.textContent = "القيمة يجب أن تكون أكبر من أو تساوي 0";
