...
function initStyleControls() {
  ...
  if (applyStyleBtn) {
    applyStyleBtn.addEventListener("click", function () {
      ...
      console.log(`تطبيق النمط على الطبقة: ${layer}`, { color, opacity, weight, lineColor });
