...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // This functionality has been moved to sidebar.js for better organization
});
...
function loadNeighborhoodsLayer() {
  ...
  if (mainLayersGroup) {
    ...
    // لا نضيف طبقة المسميات تلقائياً - ستضاف يدوياً عند تفعيلها
...
function loadServiceSectorsLayer() {
  ...
  if (mainLayersGroup) {
    ...
    // لا نضيف طبقة مسميات دوائر الخدمات تلقائياً - ستضاف يدوياً عند تفعيلها
